...
Once Grist is configured, locate ID for API use for each document:
1. Open a document.
2. Navigate to **Settings** and copy the ID for API. 
3. Update the `GRIST_*` values in `apps/vedana/.env`.
